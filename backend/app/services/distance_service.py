...
class DistanceService:
    ...
    async def _get_coordinates_from_street_name(self, address: Address):
        key_data = get_key("opencagekey", self.db)
    ...
    async def insert_address(self, address: Address):
        try:
            ...
            coordinates = self._get_coordinates_from_street_name(address.street, address.street_number, address.zip_code, address.city)
